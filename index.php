...
<!-- header -->
	<div class="header_bg">
		<div class="container">
			...
			<div class="header">
				<div class="logo">
                                    <a href="index.php"><img src="images/me.jpg" alt="s " /></a>
				</div>
		...
		<div class="container">
			<div class="wlcome-grids">
				<div class="col-md-7 wlcome-grid-left">
					...
					<div class="services">
						<h2>Instructions and Rules for Election !</h2>
								...
								<div class="panel-heading" role="tab" id="headingOne">
								  <h4 class="panel-title">
									<a class="pa_italic" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
									  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>about registration
									</a>
								  </h4>
								</div>
								...
								<div class="panel-heading" role="tab" id="headingTwo">
								  <h4 class="panel-title">
									<a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
									  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>about vote casting
									</a>
								  </h4>
								</div>
							  ...
							  <ul class="resp-tabs-list">
								...
								<div class="resp-tabs-container">
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
										<div class="facts">
										  <div class="tab_list">
											<img src="images/medrek.jpg" alt=" " class="img-responsive">
										  </div>
										  <div class="tab_list1">
										...
										<div class="facts">
										   <div class="tab_list">
												<img src="images/eprdf.jpg" alt=" " class="img-responsive">
										  </div>
										  <div class="tab_list1">
											<a href="#">excepturi sint occaecati</a>
										...
										<div class="facts">
										   <div class="tab_list">
												<img src="images/abden.jpg" alt=" " class="img-responsive">
										  </div>
										  <div class="tab_list1">
											<a href="#">excepturi sint occaecati</a>
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
										<div class="facts">
										  <div class="tab_list">
												<img src="images/andm.jpg" alt=" " class="img-responsive">
										  </div>
										  <div class="tab_list1">
											<a href="#">excepturi sint occaecati</a>
										...
										<div class="facts">
										   <div class="tab_list">
												<img src="images/aenm.jpg" alt=" " class="img-responsive">
										  </div>
										  <div class="tab_list1">
											<a href="#">excepturi sint occaecati</a>
										...
										<div class="facts">
										   <div class="tab_list">
												<img src="images/tigri-worj.jpg" alt=" " class="img-responsive">
										  </div>
										  <div class="tab_list1">
											<a href="#">excepturi sint occaecati</a>
